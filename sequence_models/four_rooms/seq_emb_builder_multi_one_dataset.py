...
SEQ_DIR: Optional[Path] = Path("sequence_models/data/four_rooms/")  # or None

# Shared dataset for all sequences
DATASET_JSON: Path = Path("sequence_models/data/four_rooms_merged.json")
...
OUTPUT_DIR: Optional[Path] = Path("sequence_models/data/four_rooms/no_summary")  # or None
