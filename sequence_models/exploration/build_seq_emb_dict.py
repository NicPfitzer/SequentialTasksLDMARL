...
# ───────────────────────── CONFIG ───────────────────────── #
SEQ_JSON      = Path("sequence_models/data/random_walk_defend_results.json")       # ← edit me
DATASET_JSON  = Path("sequence_models/data/merged.json")   # ← edit me
OUTPUT_JSON   = Path("sequence_models/data/dataset_no_summary_flag_defense.json")  # ← edit me or set to None
...
def extend_sequences(
    ...
    for i, seq in enumerate(seq_list):
        ...
        grids = [state_to_pair[i][s]["grid"] for s in seq["states"]]
