...
# Input files
INPUT_FILES = [
    (Path("sequence_models/data/dataset_no_summary_flag_home.json"), "FLAG_HOME"),
    (Path("sequence_models/data/dataset_no_summary_flag_defense.json"), "DEFEND")
]

# Output file
OUTPUT_JSON = Path("sequence_models/data/dataset_full_grid.json")
