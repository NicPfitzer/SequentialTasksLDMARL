...
# ───────────────────────── CONFIG ───────────────────────── #
SEQ_JSON      = Path("sequence_models/data/random_walk_rgbp_switch_goal_results.json")       # ← edit me
DATASET_JSON  = Path("sequence_models/data/four_flags_merged.json")   # ← edit me
OUTPUT_JSON   = Path("sequence_models/data/dataset_no_summary_four_flags.json")  # ← edit me or set to None
