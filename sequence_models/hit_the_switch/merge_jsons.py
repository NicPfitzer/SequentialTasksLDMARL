...
KEY_TO_SOURCE: Dict[str, Tuple[str, Optional[str]]] = {
    "S":  ("sequence_models/data/language_data_complete_switch.json",   None),
    "G":  ("sequence_models/data/language_data_complete_goal.json", None),
}

OUTPUT_FILE = "sequence_models/data/hit_the_switch_merged.json"
